# Pinterest Hub Driver Memory
## Scope
- Package role: Normalization (Drivers)
- Purpose: This package operates within the Normalization (Drivers) layer of the APIs Hub SaaS hierarchy, providing data normalization for the Pinterest ecosystem.
...
## Current notes
- Pinterest driver currently relies on the shared core stack only.